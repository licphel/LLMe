...
class MiniLM(nn.Module):
    def __init__(self, vocab_size, dim=256, n_layers=4, n_heads=4, max_seq_len=512, dropout=0.1):
        super().__init__()
        ...
        print(f"Model created: vocab_size={vocab_size}, dim={dim}, layers={n_layers}, heads={n_heads}")
